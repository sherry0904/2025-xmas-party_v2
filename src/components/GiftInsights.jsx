      ...
      >
        ...
        <div className="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white/80 backdrop-blur z-10">
          <div>
            ...
            <p className="text-sm text-gray-500">Analysis of everyone's ratings</p>
          </div>
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-blue-50 p-4 rounded-2xl border border-blue-100">
              <div className="flex items-center gap-2 mb-3 text-blue-800 font-bold uppercase text-xs tracking-wider">
                <Package className="w-4 h-4" /> Giver Confidence
              </div>
              
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-blue-600">Most Confident</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-blue-600">Least Confident</span>
                  <div className="text-right">
            ...
            <div className="bg-purple-50 p-4 rounded-2xl border border-purple-100">
              <div className="flex items-center gap-2 mb-3 text-purple-800 font-bold uppercase text-xs tracking-wider">
                <User className="w-4 h-4" /> Receiver Difficulty
              </div>
              
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-purple-600">Easiest to Gift</span>
                  <div className="text-right">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-purple-600">Hardest to Gift</span>
                  <div className="text-right">
          ...
          {/* Detailed Table */}
          <div>
            <h3 className="font-serif font-bold text-gray-700 mb-4">Detailed Breakdown</h3>
            <div className="overflow-hidden rounded-xl border border-gray-200">
              <table className="w-full text-sm text-left">
                <thead className="bg-gray-50 text-gray-500 font-bold uppercase text-xs">
                  <tr>
                    <th className="px-4 py-3">Player</th>
                    <th className="px-4 py-3 text-right">Giver Confidence<br/><span className="text-[10px] font-normal normal-case opacity-70">(Avg. Rating Given)</span></th>
                    <th className="px-4 py-3 text-right">Receiver Suitability<br/><span className="text-[10px] font-normal normal-case opacity-70">(Avg. Rating Received)</span></th>
                  </tr>
                </thead>
